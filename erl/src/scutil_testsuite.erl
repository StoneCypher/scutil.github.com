...
-svn_id("$Id: scutil_testsuite.erl 203 2009-03-16 00:36:01Z john $").
-svn_head("$HeadURL: svn://crunchyd.com/scutil/src/scutil_testsuite.erl $").
-svn_revision("$Revision: 203 $").
