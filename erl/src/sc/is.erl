...
-svn_id("$Id: is.erl 260 2009-03-23 01:44:10Z john $").
-svn_head("$HeadURL: svn://crunchyd.com/scutil/src/sc/is.erl $").
-svn_revision("$Revision: 260 $").

-description("Identification and information functions.").
