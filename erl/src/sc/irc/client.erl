...
-svn_id("$Id: client.erl 258 2009-03-22 21:56:55Z john $").
-svn_head("$HeadURL: svn://crunchyd.com/scutil/src/sc/irc/client.erl $").
-svn_revision("$Revision: 258 $").

-description("Client module for the IRC protocol.").

-testerl_export( { [], sc_irc_client_testsuite } ).  % todo needs test suite
