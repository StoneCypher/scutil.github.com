...
-svn_id("$Id: nickserv.erl 259 2009-03-23 00:40:13Z john $").
-svn_head("$HeadURL: svn://crunchyd.com/scutil/src/sc/irc/server/nickserv.erl $").
-svn_revision("$Revision: 259 $").

-description("Nickserv service for the SC IRC server").

-testerl_export( { [], sc_irc_server_nickserv_testsuite } ).  % todo needs test suite
