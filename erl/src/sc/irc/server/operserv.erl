...
-svn_id("$Id: operserv.erl 259 2009-03-23 00:40:13Z john $").
-svn_head("$HeadURL: svn://crunchyd.com/scutil/src/sc/irc/server/operserv.erl $").
-svn_revision("$Revision: 259 $").

-description("Operserv service for the SC IRC server").

-testerl_export( { [], sc_irc_server_operserv_testsuite } ).  % todo needs test suite
