...
-svn_id("$Id: chanserv.erl 259 2009-03-23 00:40:13Z john $").
-svn_head("$HeadURL: svn://crunchyd.com/scutil/src/sc/irc/server/chanserv.erl $").
-svn_revision("$Revision: 259 $").

-description("Chanserv service for the SC IRC server").

-testerl_export( { [], sc_irc_server_chanserv_testsuite } ).  % todo needs test suite
