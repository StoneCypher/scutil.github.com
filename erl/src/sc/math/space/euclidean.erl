...
-module(sc.math.space.euclidean).
...
-svn_id("$Id: euclidean.erl 264 2009-03-23 05:49:11Z john $").
-svn_head("$HeadURL: svn://crunchyd.com/scutil/src/sc/math/space/euclidean.erl $").
