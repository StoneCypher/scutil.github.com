...
-svn_id("$Id: net.erl 262 2009-03-23 02:28:23Z john $").
-svn_head("$HeadURL: svn://crunchyd.com/scutil/src/sc/net.erl $").
-svn_revision("$Revision: 262 $").

-description("Network routines and wrappers").

-testerl_export( { [], sc_net_testsuite } ).  % todo needs test suite
