...
-module(sc.bridges.net.javascript).
...
-svn_id("$Id: javascript.erl 264 2009-03-23 05:49:11Z john $").
-svn_head("$HeadURL: svn://crunchyd.com/scutil/src/sc/bridges/net/javascript.erl $").
-svn_revision("$Revision: 264 $").

-description("The erlang side of an erlang/javascript bridge.  Uses AJAX/Comet and the htstub webserver, which is also part of scutil.").

-testerl_export( { [], sc_bridges_net_javascript_testsuite } ).  % todo needs test suite
