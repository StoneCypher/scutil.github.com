...
-module(sc.bridges.net.actionscript).
...
-svn_id("$Id: actionscript.erl 258 2009-03-22 21:56:55Z john $").
-svn_head("$HeadURL: svn://crunchyd.com/scutil/src/sc/bridges/net/actionscript.erl $").
-svn_revision("$Revision: 258 $").

-description("The erlang side of the erlang/actionscript bridge formerly known as flerl").

-testerl_export( { [], sc_bridges_net_actionscript_testsuite } ).  % todo needs test suite
