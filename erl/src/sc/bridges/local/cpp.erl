...
-svn_id("$Id: cpp.erl 258 2009-03-22 21:56:55Z john $").
-svn_head("$HeadURL: svn://crunchyd.com/scutil/src/sc/bridges/local/cpp.erl $").
-svn_revision("$Revision: 258 $").

-description("Standard bridge to C++ applications.").

-testerl_export( { [], sc_bridges_local_cpp_testsuite } ).  % todo needs test suite
