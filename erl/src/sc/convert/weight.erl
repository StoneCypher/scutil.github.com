...
-svn_id("$Id: weight.erl 255 2009-03-22 08:10:27Z john $").
-svn_head("$HeadURL: svn://crunchyd.com/scutil/src/sc/convert/weight.erl $").
-svn_revision("$Revision: 255 $").

-description("Utilities to convert between weight notations").

-testerl_export( { [], sc_convert_weight_testsuite } ).  % todo needs test suite
