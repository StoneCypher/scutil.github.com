...
-svn_id("$Id: tcp.erl 259 2009-03-23 00:40:13Z john $").
-svn_head("$HeadURL: svn://crunchyd.com/scutil/src/sc/htstub/tcp.erl $").
-svn_revision("$Revision: 259 $").

-description("TCP/IP driver for HtStub").

-testerl_export( { [], sc_htstub_tcp_testsuite } ).  % todo needs test suite
